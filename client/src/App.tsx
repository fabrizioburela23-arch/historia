...
import RoutingsPage from './pages/admin/RoutingsPage'
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<RequireAuth><Layout /></RequireAuth>}>
          ...
          <Route path="/admin/raw-materials" element={<RequireAdmin><RawMaterialsPage /></RequireAdmin>} />
          <Route path="/admin/operations" element={<RequireAdmin><OperationsPage /></RequireAdmin>} />
          <Route path="/admin/routings" element={<RequireAdmin><RoutingsPage /></RequireAdmin>} />
